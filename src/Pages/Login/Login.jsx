...
const Login = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center h-screen gap-x-10 pt-20 mb-52">
      <div className="w-full md:w-1/2 py-20 pr-2">
        <ImageBox />
      </div>

      <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-3/4 bg-white rounded px-8 pt-6 pb-8">
